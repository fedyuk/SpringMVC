...
<html lang="en">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" method="post" action='buy.do?productId=${product[0]}' >
  <div class="form-group">
    <label for="email">Name:</label>
  ...
  <button type="submit" class="btn btn-primary">Buy</button>	
										...
										<div class="thumbnail">
										<p id="productId" style="display: none;">${product[0]}</p>
...
<c:url var="lastUrl" value="/products?categoryId=${categoryId}&page=${page.totalPages}" />
<c:url var="prevUrl" value="/products?categoryId=${categoryId}&page=${currentIndex - 1}" />
<c:url var="nextUrl" value="/products?categoryId=${categoryId}&page=${currentIndex + 1}" />
...
<div align="center">
    <ul class="pagination">
        ...
        <c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
            <c:url var="pageUrl" value="/products?categoryId=${categoryId}&page=${i}" />
            <c:choose>
