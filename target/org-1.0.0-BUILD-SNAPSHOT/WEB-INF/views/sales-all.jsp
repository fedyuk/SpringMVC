...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <strong><i class="glyphicon glyphicon-user"></i> All sales</strong>
            <hr>
            <div class="row">
        <div class="col-md-12">
            ...
            <tbody>
             <c:forEach items="${sales}" var="sale">
              <tr>
                ...
                <td  class="text-center"><a href="<s:url value="/sale/delete?salesOrderId=${sale[0]}"/>" role="button" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-trash"></i>delete</a></td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
        </div>
        <c:url var="firstUrl" value="/sale/all?page=1" />
<c:url var="lastUrl" value="/sale/all?page=${page.totalPages}" />
<c:url var="prevUrl" value="/sale/all?page=${currentIndex - 1}" />
<c:url var="nextUrl" value="/sale/all?page=${currentIndex + 1}" />
...
<div align="center">
    <ul class="pagination">
        ...
        <c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
            <c:url var="pageUrl" value="/sale/all?page=${i}" />
            <c:choose>
