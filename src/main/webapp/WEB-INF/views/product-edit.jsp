...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <title>Редагування номенклатури товару</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <strong><i class="glyphicon glyphicon-plus"></i> Редагування номенклатури товару</strong>
            <hr>
        <div class="col-md-12">
          <springForm:form class="form-horizontal" method="post" action='edit.do' name="editForm" id="MyForm2" commandName="product">
					<div class="form-group">
						<label for="ID" >Номер номенклатури товару:</label>
						
							<input class="form-control" type="text" name="productId" id="productId" title="Name" value="${product.productId}" required autofocus autocomplete="off" readonly>
						
					</div>
					<div class="form-group">
						<label for="Name" >Назва номенклатури товару:</label>
						
							<input class="form-control" type="text" name="name" id="name" title="Name" value="${product.name}" placeholder="Введіть нову номенклатуру товару" required autofocus autocomplete="off">
