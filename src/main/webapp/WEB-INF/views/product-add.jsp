...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <title>Додавання номенклатури товару</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <strong><i class="glyphicon glyphicon-plus"></i> Додати нову номенклатуру товару</strong>
            <hr>
        <div class="col-md-12">
          <springForm:form class="form-horizontal" method="post" action='add.do' name="addForm" id="MyForm" commandName="product">
					<div class="form-group">
						<label for="Email" >Назва номенклатури товару:</label>
						
							<input class="form-control" type="text" name="name" id="name" title="Name" value="${product.name}" placeholder="Введіть назву номенклатури товару" required autofocus autocomplete="off">
