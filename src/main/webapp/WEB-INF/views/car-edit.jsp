...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <strong><i class="glyphicon glyphicon-plus"></i> Редагування машини</strong>
            <hr>
        <div class="col-md-12">
          <springForm:form class="form-horizontal" method="post" action='edit.do' name="editForm" id="MyForm2" commandName="car">
					<div class="form-group">
						<label for="ID" >Номер машини:</label>
						
							<input class="form-control" type="text" name="carId" id="carId" title="Name" value="${car.carId}" required autofocus autocomplete="off" readonly>
						
					</div>
					<div class="form-group">
						<label for="Email" >Марка машини:</label>
						
							<input class="form-control" type="text" name="brand" id="brand" title="Name" value="${car.brand}" placeholder="Введіть нову марку машини" autofocus autocomplete="off">
						
					</div>
					<div class="form-group">
						<label for="Email" >Номера машини:</label>
						
							<input class="form-control" type="text" name="carNumber" id="carNumber" title="Name" value="${car.carNumber}" placeholder="Введіть нові номера машини" required autofocus autocomplete="off">
						
					</div>
					<div class="row">
                           <springForm:errors path="carNumber" class="text-danger" />
                    </div>
                    <div class="form-group">
						<label for="Email" >Номера прицепа:</label>
						
							<input class="form-control" type="text" name="trailerNumber" id="trailerNumber" title="Name" value="${car.trailerNumber}" placeholder="Введіть нові номера прицепа" autofocus autocomplete="off">
						
					</div>
					<div class="form-group">
						<label for="Email" >Телефон директора:</label>
						
							<input class="form-control" type="text" name="directorPhoneNumber" id="directorPhoneNumber" title="Name" value="${car.directorPhoneNumber}" placeholder="Введіть телефон директора" autofocus autocomplete="off">
