...
<form id="divDriver" action='searchDriver.do' method='POST' class="form-search" style="display:none;">
  ...
  <button type="submit" class="btn">Search</button>
        ...
        <c:url var="firstUrl" value="/transportation/all?page=1" />
<c:url var="lastUrl" value="/transportation/all?page=${page.totalPages}" />
<c:url var="prevUrl" value="/transportation/all?page=${currentIndex - 1}" />
<c:url var="nextUrl" value="/transportation/all?page=${currentIndex + 1}" />
...
<div align="center">
    <ul class="pagination">
        ...
        <c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
            <c:url var="pageUrl" value="/transportation/all?page=${i}" />
            <c:choose>
