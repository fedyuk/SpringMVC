...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <strong><i class="glyphicon glyphicon-user"></i> Всі водії</strong>
            <hr>
            <div class="row">
        <div class="col-md-12">
          <table class="table table-condensed table-striped table-bordered">
            <thead>
              <tr>
                <th class="text-center small">Прізвище</th>
                <th class="text-center small">Ім'я</th>
                <th class="text-center small">По-батькові</th>
                <th class="text-center small">Номер телефону</th>
                <th class="text-center small">Марка машини</th>
                <th class="text-center small">Номера машини</th>
            ...
            <tbody>
             <c:forEach items="${drivers}" var="driver">
              <tr>
                <td class="text-center small"><c:out value="${driver.lastName}"/></td>
                <td class="text-center small"><c:out value="${driver.firstName}"/></td>
                <td class="text-center small"><c:out value="${driver.middleName}"/></td>
                <td class="text-center small"><c:out value="${driver.phoneNumber}"/></td>
                <td class="text-center small"><c:out value="${driver.car.brand}"/></td>
                <td class="text-center small"><c:out value="${driver.car.carNumber}"/></td>
                <td class="text-center small"><a href="<s:url value="/driver/edit?driverId=${driver.driverId}"/>" role="button" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-edit"></i>редагувати</a></td>
                <td class="text-center small"><a href="<s:url value="/driver/delete?driverId=${driver.driverId}"/>" role="button" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-trash"></i>видалити</a></td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
        </div>
        <c:url var="firstUrl" value="/driver/all?page=1" />
<c:url var="lastUrl" value="/driver/all?page=${page.totalPages}" />
<c:url var="prevUrl" value="/driver/all?page=${currentIndex - 1}" />
<c:url var="nextUrl" value="/driver/all?page=${currentIndex + 1}" />
...
<div align="center">
    <ul class="pagination">
        ...
        <c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
            <c:url var="pageUrl" value="/driver/all?page=${i}" />
            <c:choose>
