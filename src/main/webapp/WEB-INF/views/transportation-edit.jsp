...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <title>Редагування перевезення</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <strong><i class="glyphicon glyphicon-edit"></i> Редагувати перевезення</strong>
            <hr>
        <div class="col-md-12">
          <springForm:form class="form-horizontal" method="post" action='edit.do' name="addForm" id="MyForm" commandName="transportation">
					<div class="form-group">
					<label for="Categories" >Номер перевезення:</label>
							<input class="form-control input-sm" type="text" name="transportationId" id="transportationId" title="loadDate" value="${transportation.transportationId}" required  autocomplete="off" readonly>
                    </div>
					<div class="form-group">
