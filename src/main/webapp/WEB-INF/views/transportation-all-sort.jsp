...
<form id="divDriver" action='searchDriver.do' method='POST' class="form-search" style="display:none;">
  ...
  <button type="submit" class="btn">Search</button>
            ...
            <div class="col-md-2"> 
                 <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown"> Сортувати за критерієм
                     <span class="caret"></span> 
                 </button> 
                      <ul class="dropdown-menu" role="menu"> 
                          <li ><a href="<s:url value="/transportation/all?page=${currentIndex}&sortType=loadAddress"/>">Місце завантаження</a></li> 
                          <li ><a href="<s:url value="/transportation/all?page=${currentIndex}&sortType=unloadAddress"/>">Місце розвантаження</a></li> 
                          <li ><a href="<s:url value="/transportation/all?page=${currentIndex}&sortType=loadDate"/>">Дата завантаження</a></li> 
                          <li ><a href="<s:url value="/transportation/all?page=${currentIndex}&sortType=unloadDate"/>">Дата розвантаження</a></li> 
                          <li ><a href="<s:url value="/transportation/all?page=${currentIndex}&sortType=countOfUnits"/>">К-сть штук</a></li> 
                          <li ><a href="<s:url value="/transportation/all?page=${currentIndex}&sortType=weight"/>">Маса вантажу</a></li> 
                          <li ><a href="<s:url value="/transportation/all?page=${currentIndex}&sortType=status"/>">Статус</a></li> 
                       </ul>
               </div>
            </div>
            <hr>
        ...
        <c:url var="firstUrl" value="/transportation/all?page=1&sortType=${sortType}" />
<c:url var="lastUrl" value="/transportation/all?page=${page.totalPages}&sortType=${sortType}" />
<c:url var="prevUrl" value="/transportation/all?page=${currentIndex - 1}&sortType=${sortType}" />
<c:url var="nextUrl" value="/transportation/all?page=${currentIndex + 1}&sortType=${sortType}" />
...
<div align="center">
    <ul class="pagination">
        ...
        <c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
            <c:url var="pageUrl" value="/transportation/all?page=${i}&sortType=${sortType}" />
            <c:choose>
