...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <title>Всі номенклатури товарів</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <strong><i class="glyphicon glyphicon-user"></i> Всі номенклатури товарів</strong>
            <hr>
            <div class="row">
        <div class="col-md-12">
          <table class="table table-condensed table-striped table-bordered">
            <thead>
              <tr>
                ...
                <th class="text-center small">Номенклатура товару</th>
            ...
            <tbody>
             <c:forEach items="${products}" var="product">
              <tr>
                <td class="text-center small"><c:out value="${product.productId}"/></td>
                <td class="text-center small"><c:out value="${product.name}"/></td>
                <td class="text-center small"><a href="<s:url value="/product/edit?productId=${product.productId}"/>" role="button" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-edit"></i>редагувати</a></td>
                <td class="text-center small"><a href="<s:url value="/product/delete?productId=${product.productId}"/>" role="button" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-trash"></i>видалити</a></td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
