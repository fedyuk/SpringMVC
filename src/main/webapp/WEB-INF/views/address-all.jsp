...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <strong><i class="glyphicon glyphicon-user"></i> Всі адреси</strong>
            <hr>
            <div class="row">
        <div class="col-md-12">
          <table class="table table-condensed table-striped table-bordered">
            <thead>
              <tr>
                ...
                <th class="text-center small">Адреса</th>
            ...
            <tbody>
             <c:forEach items="${addresses}" var="address">
              <tr>
                <td class="text-center small"><c:out value="${address.addressId}"/></td>
                <td class="text-center small"><c:out value="${address.name}"/></td>
                <td class="text-center small"><a href="<s:url value="/address/edit?addressId=${address.addressId}"/>" role="button" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-edit"></i>редагувати</a></td>
                <td class="text-center small"><a href="<s:url value="/address/delete?addressId=${address.addressId}"/>" role="button" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-trash"></i>видалити</a></td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
        </div>
        <c:url var="firstUrl" value="/address/all?page=1" />
<c:url var="lastUrl" value="/address/all?page=${page.totalPages}" />
<c:url var="prevUrl" value="/address/all?page=${currentIndex - 1}" />
<c:url var="nextUrl" value="/address/all?page=${currentIndex + 1}" />
...
<div align="center">
    <ul class="pagination">
        ...
        <c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
            <c:url var="pageUrl" value="/address/all?page=${i}" />
            <c:choose>
