...
<form id="divDriver" action='searchDriver.do' method='POST' class="form-search" style="display:none;">
  ...
  <button type="submit" class="btn">Search</button>
        ...
        <c:url var="firstUrl" value="/transportation/all?page=1&searchBy=${searchBy}&value=${value}" />
<c:url var="lastUrl" value="/transportation/all?page=${page.totalPages}&searchBy=${searchBy}&value=${value}" />
<c:url var="prevUrl" value="/transportation/all?page=${currentIndex - 1}&searchBy=${searchBy}&value=${value}" />
<c:url var="nextUrl" value="/transportation/all?page=${currentIndex + 1}&searchBy=${searchBy}&value=${value}" />
...
<div align="center">
    <ul class="pagination">
        ...
        <c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
            <c:url var="pageUrl" value="/transportation/all?page=${i}&searchBy=${searchBy}&value=${value}" />
            <c:choose>
