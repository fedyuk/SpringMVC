...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <strong><i class="glyphicon glyphicon-plus"></i> Редагування адреси</strong>
            <hr>
        <div class="col-md-12">
          <springForm:form class="form-horizontal" method="post" action='edit.do' name="editForm" id="MyForm2" commandName="address">
					<div class="form-group">
						<label for="ID" >Номер адреси:</label>
						
							<input class="form-control" type="text" name="addressId" id="addressId" title="Name" value="${address.addressId}" required autofocus autocomplete="off" readonly>
