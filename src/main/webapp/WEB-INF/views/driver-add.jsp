...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <strong><i class="glyphicon glyphicon-plus"></i> Додати нового водія</strong>
            <hr>
        <div class="col-md-12">
          <springForm:form class="form-horizontal" method="post" action='add.do' name="addForm" id="MyForm" commandName="driver">
					<div class="form-group">
						<label for="Email" >Прізвище водія:</label>
						
							<input class="form-control" type="text" name="lastName" id="lastName" title="Name" value="${driver.lastName}" placeholder="Введіть прізвище водія" required autofocus autocomplete="off">
					...
					<c:if test="${driver.car.carId!=null}">
                    ...
                    <div class="row">
                           <springForm:errors path="car" class="text-danger" />
                    </div>
                    <div class="form-group">
